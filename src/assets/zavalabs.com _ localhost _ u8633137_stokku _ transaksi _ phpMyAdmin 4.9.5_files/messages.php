...
<head>
    ...
    <link href="/cPanel_magic_revision_1618370027/unprotected/cpanel/style_v2_optimized.css" rel="stylesheet" type="text/css" />
...
.copyright {
  ...
  background-size: 25px auto;
    ...
    <style type="text/css">
        img {
            behavior: url(/cPanel_magic_revision_1573674718/unprotected/cp_pngbehavior_login.htc);
        }
    </style>
    <![endif]-->
...
<input type="hidden" id="goto_uri" value="/3rdparty/phpMyAdmin/js/messages.php?l=id&amp;v=4.9.5" />
    ...
    <div id="notify">
        <noscript>
            <div class="error-notice">
                <img src="/cPanel_magic_revision_1573673575/unprotected/cpanel/images/notice-error.png" alt="Error" align="left"/>
                JavaScript dinonaktifkan di browser Anda.
                Agar cPanel berfungsi dengan benar, Anda harus mengaktifkan JavaScript.
                Jika Anda tidak mengaktifkan JavaScript, fitur tertentu di cPanel tidak akan berfungsi dengan benar.
            </div>
            </noscript>
        ...
        <div id='login-status' class="error-notice" style="visibility: hidden">
            <div class="content-wrapper">
                <div id="login-detail">
                    ...
                    <div id="login-status-message">Anda telah keluar.</div>
                </div>
            </div>
        </div>
        ...
        <div id="login-container">
            ...
            <div id="login-sub-container">
                    <div id="login-sub-header">
                        ...
                        <img class="main-logo" src="/cPanel_magic_revision_1573673575/unprotected/cpanel/images/cpanel-logo.svg" alt="logo" />
                    ...
                    <div id="login-sub"
                        ...
                        <div id="forms">
                            <form novalidate id="login_form" action="/login/" method="post" target="_self" style="visibility:">
                                <div class="input-req-login"><label for="user">Nama pengguna</label></div>
                                <div class="input-field-login icon username-container">
                                    <input name="user" id="user" autofocus="autofocus" value="" placeholder="Masukkan nama pengguna." class="std_textbox" type="text"  tabindex="1" required>
                                </div>
                                <div class="input-req-login login-password-field-label"><label for="pass">Kata sandi</label></div>
                                <div class="input-field-login icon password-container">
                                    <input name="pass" id="pass" placeholder="Masukkan kata sandi akun." class="std_textbox" type="password" tabindex="2"  required>
                                </div>
                                <div class="controls">
                                    <div class="login-btn">
...
<script>
    var MESSAGES = {"ajax_timeout":"Waktu koneksi berakhir. Coba lagi.","success":"Login berhasil. Mengalihkan …","invalid_login":"Login tidak valid.","network_error":"A network error occurred during your login request. Please try again. If this condition persists, contact your network service provider.","authenticating":"Mengautentikasi …","no_username":"You must specify a username to log in.","session_locale":"Lokal yang diinginkan telah disimpan ke browser. Untuk mengubah kembali lokal di browser ini, pilih lokal lain pada layar ini.","read_below":"Read the important information below.","internal_error":"An internal error occurred. If this condition persists, contact the system administrator."};
